            ...
            <div class="kh-box-inner">
              ...
              <div class="kh-box-right">
                ...
                <div class="kh-links-list">
                  ...
                  <a href="https://www.linkedin.com/in/kamellia/" target="_blank" rel="noopener noreferrer" class="kh-link-row" style="border-color:rgba(10,102,194,0.2); background:rgba(10,102,194,0.06);">
                    <div class="kh-link-icon" style="background:#0a66c2;">
                  ...
                  <a href="https://github.com/kamelliah" target="_blank" rel="noopener noreferrer" class="kh-link-row" style="border-color:rgba(88,96,145,0.25); background:rgba(88,96,145,0.07);">
                    <div class="kh-link-icon" style="background:#24292e;">
                  ...
                  <a href="https://www.instagram.com/kamelliah/" target="_blank" rel="noopener noreferrer" class="kh-link-row" style="border-color:rgba(217,70,239,0.25); background:rgba(217,70,239,0.06);">
                    <div class="kh-link-icon" style="background:linear-gradient(135deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888);">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="#fff" stroke="none"/></svg>
                    </div>
                    <div class="kh-link-meta">
